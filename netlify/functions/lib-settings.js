...
export const POLICY_LINES = [
  ...
  "Free-admission codes (loyalty rewards, birthday gifts and classroom codes) cover one child's admission per booking, are single-use, and cannot be combined with a discount code, store credit or a referral discount. Gift cards may still be applied, as these are a payment method rather than a discount.",
  "Grip socks are required for children who are walking. They are not required for babies who are not yet walking. Grip socks may be purchased at the studio or added to your booking, and you are welcome to bring your own provided they cover most of the sole of the foot.",
  "Any Day Play Club is an upgrade on the equivalent Weekday plan and includes weekends. Play Club memberships cover open play admission only. They do not include special events or ticketed sessions and cannot be combined with other promotions or discounts, including the military discount. The military discount applies to regularly priced open play admission only.",
  "Play Club memberships are billed monthly through Square and renew automatically until cancelled. Membership visits cover admission only and are recorded in your child's visit history; they do not earn loyalty punches. Cancelling stops future billing and the current month remains active.",
