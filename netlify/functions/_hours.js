...
export async function loadSeasonal() {
  try { return (await getStore({ name: "site", consistency: "strong" }).get("seasonal-hours", { type: "json" })) || null; }
  catch { return null; }
}
...
export async function loadWeekly() {
  try { return (await getStore({ name: "site", consistency: "strong" }).get("weekly-hours", { type: "json" })) || null; }
  catch { return null; }
}
